  ...
  var t = 'selectric',
    ...
    l = {
      replaceDiacritics: function (e) {
        for (
          var t = '40-46 50-53 54-57 62-70 71-74 61 47 77'
              .replace(/\d+/g, '\\3$&')
              .split(' '),
            s = t.length;
          s--;
          ...
          e = e
            .toLowerCase()
            .replace(RegExp('[' + t[s] + ']', 'g'), 'aeiouncy'.charAt(s));
        return e;
      },
      format: function (e) {
        var t = arguments;
    ...
    c = function (n, c) {
          ...
          y.prop(
            ...
            [
              ...
              j.options.customClass.overwrite
                ? F.prop('class').replace(
                    /\S+/g,
                    j.options.customClass.prefix + '-$&',
                  )
                : F.prop('class'),
                ...
                .on('mouseenter' + o + ' mouseleave' + o, function (t) {
                  e(this).toggleClass(j.classes.hover),
                    j.options.openOnHover &&
                      ...
                      'mouseleave' == t.type
                        ? (j.closeTimer = setTimeout(
                            g,
                            j.options.hoverIntentTimeout,
                          ))
                        : m());
                }),
                ...
                .on('keydown' + o, function (e) {
                  ...
                  if (t > 36 && 41 > t) {
                    if (
                      !j.options.allowWrap &&
                      ((39 > t && 0 == S) ||
                        (t > 38 && S + 1 == j.items.length))
                    )
                      return;
                    b(
                      l[(39 > t ? 'previous' : 'next') + 'EnabledItem'](
                        j.items,
                        S,
                      ),
                    );
                ...
                .on('oninput' in x[0] ? 'input' : 'keyup', function () {
                  x.val().length &&
                    e.each(j.items, function (e, t) {
                      return RegExp('^' + x.val(), 'i').test(t.slug) &&
                        !t.disabled
                        ? (b(e), !1)
                        : void 0;
                    });
      ...
      function h(e) {
        ...
        13 == t && e.preventDefault(),
          /^(9|13|27)$/.test(t) && (e.stopPropagation(), b(S, !0));
      }
      function f() {
        var e = k
            .closest(':visible')
            .children(':hidden')
            .addClass(j.classes.tempshow),
      ...
      function g() {
        ...
        a.off(o),
          y.removeClass(j.classes.open),
          (L = !1),
          l.triggerCallback('Close', j);
      }
      function b(e, t) {
        void 0 != e &&
          (j.items[e].disabled ||
