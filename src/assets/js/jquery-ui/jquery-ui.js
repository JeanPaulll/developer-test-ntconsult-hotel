    ...
    (e.Widget.prototype = {
      ...
      _trigger: function (t, i, s) {
        ...
        return (
          ...
          !(
            (e.isFunction(r) && r.apply(this.element[0], [i].concat(s)) === !1) ||
        ...
        top: function (e, t) {
          ...
          0 > u
            ? ((s = e.top + p + f + m + t.collisionHeight - r - n),
              e.top + p + f + m > u && (0 > s || o(u) > s) && (e.top += p + f + m))
            : c > 0 &&
  ...
  e.widget('ui.draggable', e.ui.mouse, {
    ...
    _createHelper: function (t) {
      ...
      return (
        a.parents('body').length ||
          a.appendTo('parent' === i.appendTo ? this.element[0].parentNode : i.appendTo),
        a[0] === this.element[0] ||
    ...
    _getRelativeOffset: function () {
      if ('relative' === this.cssPosition) {
        ...
        return {
          ...
          left:
            e.left - (parseInt(this.helper.css('left'), 10) || 0) + this.scrollParent.scrollLeft()
        }
      }
      return { top: 0, left: 0 }
    },
                ...
                a &&
                  ...
                  (this.containment = [
                    ...
                    (t ? Math.max(a.scrollWidth, a.offsetWidth) : a.offsetWidth) -
                      ...
                      this.margins.left -
                      this.margins.right,
                    (t ? Math.max(a.scrollHeight, a.offsetHeight) : a.offsetHeight) -
      ...
      var a = 'absolute' === t ? 1 : -1,
        s =
          ...
          (this.scrollParent[0] !== document &&
            ...
            : this.offsetParent
      return (
        this.offset.scroll || (this.offset.scroll = { top: s.scrollTop(), left: s.scrollLeft() }),
        {
          top:
            i.top +
    ...
    _generatePosition: function (t) {
      var i,
        ...
        h = t.pageY
      return (
        this.offset.scroll || (this.offset.scroll = { top: o.scrollTop(), left: o.scrollLeft() }),
        this.originalPosition &&
          (this.containment &&
            ...
            this.instance._intersectsWith(this.instance.containerCache) &&
              ...
              e.each(a.sortables, function () {
                return (
                  ...
                  this !== r &&
                    this.instance._intersectsWith(this.instance.containerCache) &&
                    e.contains(r.instance.element[0], this.instance.element[0]) &&
                    (n = !1),
                  n
                )
              })),
    ...
    e.ui.plugin.add('draggable', 'scroll', {
      ...
      drag: function (t) {
        ...
        i.scrollParent[0] !== document && 'HTML' !== i.scrollParent[0].tagName
          ? ((a.axis && 'x' === a.axis) ||
              (i.overflowOffset.top + i.scrollParent[0].offsetHeight - t.pageY < a.scrollSensitivity
                ? (i.scrollParent[0].scrollTop = s = i.scrollParent[0].scrollTop + a.scrollSpeed)
                : t.pageY - i.overflowOffset.top < a.scrollSensitivity &&
                  (i.scrollParent[0].scrollTop = s = i.scrollParent[0].scrollTop - a.scrollSpeed)),
            (a.axis && 'y' === a.axis) ||
              (i.overflowOffset.left + i.scrollParent[0].offsetWidth - t.pageX < a.scrollSensitivity
                ? (i.scrollParent[0].scrollLeft = s = i.scrollParent[0].scrollLeft + a.scrollSpeed)
          ...
          : ((a.axis && 'x' === a.axis) ||
              (t.pageY - e(document).scrollTop() < a.scrollSensitivity
                ? (s = e(document).scrollTop(e(document).scrollTop() - a.scrollSpeed))
                : e(window).height() - (t.pageY - e(document).scrollTop()) < a.scrollSensitivity &&
                  (s = e(document).scrollTop(e(document).scrollTop() + a.scrollSpeed))),
            (a.axis && 'y' === a.axis) ||
              (t.pageX - e(document).scrollLeft() < a.scrollSensitivity
                ? (s = e(document).scrollLeft(e(document).scrollLeft() - a.scrollSpeed))
                : e(window).width() - (t.pageX - e(document).scrollLeft()) < a.scrollSensitivity &&
                  (s = e(document).scrollLeft(e(document).scrollLeft() + a.scrollSpeed)))),
    ...
    e.ui.plugin.add('draggable', 'snap', {
      start: function () {
        var t = e(this).data('ui-draggable'),
          i = t.options
        ;(t.snapElements = []),
          e(i.snap.constructor !== String ? i.snap.items || ':data(ui-draggable)' : i.snap).each(
            function () {
              var i = e(this),
                a = i.offset()
              this !== t.element[0] &&
      ...
      drag: function (t, i) {
        ...
        for (d = p.snapElements.length - 1; d >= 0; d--)
          (o = p.snapElements[d].left),
            ...
            h - m > b ||
            y > u + m ||
            !e.contains(p.snapElements[d].item.ownerDocument, p.snapElements[d].item)
              ...
              : ('inner' !== f.snapMode &&
                  ...
                  s &&
                    (i.position.top =
                      p._convertPositionTo('relative', { top: u, left: 0 }).top - p.margins.top),
                  n &&
                    (i.position.left =
                      p._convertPositionTo('relative', {
                        top: 0,
                ...
                'outer' !== f.snapMode &&
                  ...
                  n &&
                    (i.position.left =
                      p._convertPositionTo('relative', { top: 0, left: o }).left - p.margins.left),
                  r &&
                    (i.position.left =
                      p._convertPositionTo('relative', {
                        top: 0,
        ...
        ? (this.element
            ...
            .each(function () {
              ...
              return t.options.greedy &&
                ...
                e.ui.intersect(a, e.extend(t, { offset: t.element.offset() }), t.options.tolerance)
                ? ((s = !0), !1)
                : undefined
            }),
          s
    ...
    (e.ui.intersect = function (e, i, a) {
      ...
      switch (a) {
        ...
        case 'pointer':
          return (
            (s =
              (e.positionAbs || e.position.absolute).left + (e.clickOffset || e.offset.click).left),
            (n =
              (e.positionAbs || e.position.absolute).top + (e.clickOffset || e.offset.click).top),
        ...
        e: for (a = 0; n.length > a; a++)
          if (
            !(
              ...
              (t && !n[a].accept.call(n[a].element[0], t.currentItem || t.element))
            )
          ) {
            ...
            if (!this.options.disabled && !this.greedyChild && this.visible) {
              ...
              o &&
                (this.options.greedy &&
                  ...
                  n.length &&
                    ((a = e.data(n[0], 'ui-droppable')), (a.greedyChild = 'isover' === o))),
                a && 'isover' === o && ((a.isover = !1), (a.isout = !0), a._out.call(a, i)),
                (this[o] = !0),
                (this['isout' === o ? 'isover' : 'isout'] = !1),
                this['isover' === o ? '_over' : '_out'].call(this, i),
                a && 'isout' === o && ((a.isout = !1), (a.isover = !0), a._over.call(a, i)))
            }
          })
      },
  ...
  e.widget('ui.resizable', e.ui.mouse, {
    ...
    _mouseStart: function (i) {
      ...
      return (
        ...
        /absolute/.test(h.css('position'))
          ...
          : h.is('.ui-draggable') && h.css({ position: 'absolute', top: o.top, left: o.left }),
        this._renderProxy(),
        (s = t(this.helper.css('left'))),
        (a = t(this.helper.css('top'))),
        r.containment &&
          ((s += e(r.containment).scrollLeft() || 0), (a += e(r.containment).scrollTop() || 0)),
      ...
      return (
        this._helper &&
          ...
          (o =
            ...
            null),
          (h =
            parseInt(u.element.css('top'), 10) + (u.position.top - u.originalPosition.top) || null),
    ...
    _updateRatio: function (e) {
      ...
      return (
        ...
        'nw' === a &&
          ((e.top = t.top + (s.height - e.height)), (e.left = t.left + (s.width - e.width))),
        e
      )
    },
      ...
      resize: function (t) {
        ...
        d[0] !== document && /static/.test(d.css('position')) && (c = h),
          l.left < (r._helper ? h.left : 0) &&
            ((r.size.width =
              r.size.width + (r._helper ? r.position.left - h.left : r.position.left - c.left)),
          ...
          (i = Math.abs(
            (r._helper ? r.offset.left - c.left : r.offset.left - c.left) + r.sizeDiff.width
          )),
          (s = Math.abs(
            (r._helper ? r.offset.top - c.top : r.offset.top - h.top) + r.sizeDiff.height
          )),
      ...
      resize: function () {
        ...
        ;(i.grid = o),
          ...
          /^(se|s|e)$/.test(r)
            ...
            : /^(ne)$/.test(r)
              ? ((t.size.width = d), (t.size.height = p), (t.position.top = n.top - c))
              : /^(sw)$/.test(r)
                ? ((t.size.width = d), (t.size.height = p), (t.position.left = n.left - u))
                : ((t.size.width = d),
                  (t.size.height = p),
        ...
        this.options.disabled ||
          ...
          e(t.target)
            ...
            .each(function () {
              ...
              return a
                ? ((s = (!t.metaKey && !t.ctrlKey) || !a.$element.hasClass('ui-selected')),
                  a.$element
        ...
        return (
          ...
          this.selectees.each(function () {
            ...
            i &&
              ...
              ('touch' === a.tolerance
                ? (l = !(i.left > o || n > i.right || i.top > h || r > i.bottom))
                : 'fit' === a.tolerance &&
...
;(function (e) {
  ...
  e.widget('ui.sortable', e.ui.mouse, {
    ...
    _setOption: function (t, i) {
      'disabled' === t
        ? ((this.options[t] = i), this.widget().toggleClass('ui-sortable-disabled', !!i))
        : e.Widget.prototype._setOption.apply(this, arguments)
    },
      ...
      for (
          ...
          this.options.scroll &&
            (this.scrollParent[0] !== document && 'HTML' !== this.scrollParent[0].tagName
              ...
              : (t.pageY - e(document).scrollTop() < r.scrollSensitivity
                  ? (o = e(document).scrollTop(e(document).scrollTop() - r.scrollSpeed))
                  : e(window).height() - (t.pageY - e(document).scrollTop()) <
                      r.scrollSensitivity &&
                    (o = e(document).scrollTop(e(document).scrollTop() + r.scrollSpeed)),
                t.pageX - e(document).scrollLeft() < r.scrollSensitivity
                  ? (o = e(document).scrollLeft(e(document).scrollLeft() - r.scrollSpeed))
        ...
        if (
          ...
          n &&
            ...
            ('semi-dynamic' === this.options.type ? !e.contains(this.element[0], a) : !0))
        ) {
          if (
        ...
        if (1 === this.containers.length)
          ...
          for (
            ...
            e.contains(this.containers[m].element[0], this.items[n].item[0]) &&
              ...
              r > Math.abs(c - u) &&
                ((r = Math.abs(c - u)), (o = this.items[n]), (this.direction = d ? 'up' : 'down')))
    ...
    _convertPositionTo: function (t, i) {
      ...
      return {
        top:
          ...
          ('fixed' === this.cssPosition ? -this.scrollParent.scrollTop() : n ? 0 : a.scrollTop()) *
            s,
        left:
          i.left +
    ...
    _generatePosition: function (t) {
      ...
      return (
        ...
        this.originalPosition &&
          ...
          a.grid &&
            ((i =
              this.originalPageY + Math.round((r - this.originalPageY) / a.grid[1]) * a.grid[1]),
            (r = this.containment
              ...
              : s))),
        {
          top:
            ...
            this.offset.relative.top -
            this.offset.parent.top +
            ('fixed' === this.cssPosition ? -this.scrollParent.scrollTop() : h ? 0 : o.scrollTop()),
          left:
            n -
            this.offset.click.left -
            this.offset.relative.left -
                    ...
                    ;(i.now = Math.round(e)),
                      'height' !== i.prop
                        ...
                        : 'content' !== h.options.heightStyle &&
                          ((i.now = Math.round(n - t.outerHeight() - l)), (l = 0))
                  }
                }),
                undefined)
              : t.animate(i, o, r, p)
  ...
  e.widget('ui.button', {
    ...
    _setOption: function (e, t) {
      return (
        this._super(e, t),
        'disabled' === e
          ? (t ? this.element.prop('disabled', !0) : this.element.prop('disabled', !1), undefined)
    ...
    _resetButton: function () {
      ...
      a.primary || a.secondary
        ? (this.options.text &&
            n.push('ui-button-text-icon' + (s ? 's' : a.primary ? '-primary' : '-secondary')),
          a.primary &&
            t.prepend("<span class='ui-button-icon-primary ui-icon " + a.primary + "'></span>"),
          a.secondary &&
            t.append("<span class='ui-button-icon-secondary ui-icon " + a.secondary + "'></span>"),
          this.options.text ||
    ...
    parseDate: function (i, a, s) {
      ...
      if (
        (-1 === g
          ...
          : 100 > g &&
            (g +=
              new Date().getFullYear() - (new Date().getFullYear() % 100) + (d >= g ? 0 : -100)),
        b > -1)
      )
        for (v = 1, y = b; ; ) {
      ...
      if ((0 > Z && ((Z += 12), et--), X))
        for (
          t = this._daylightSavingAdjust(
            new Date(X.getFullYear(), X.getMonth() - B[0] * B[1] + 1, X.getDate())
          ),
            t = q && q > t ? q : t;
        ...
        for (D = '', this.maxRows = 4, w = 0; B[1] > w; w++) {
          ...
          for (
            ...
            (C = (k + u) % 7),
              (N +=
                '<th' +
                ((k + u + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : '') +
                '>' +
                "<span title='" +
                c[C] +
                "'>" +
            ...
            for (
              ...
              (z = g ? g.apply(e.input ? e.input[0] : null, [j]) : [!0, '']),
                ...
                (E +=
                  ...
                  ((j.getTime() === T.getTime() && Z === e.selectedMonth && e._keyEvent) ||
                  ...
                  (L && !v
                    ...
                    : ' ' +
                      z[1] +
                      (j.getTime() === G.getTime() ? ' ' + this._currentClass : '') +
                      (j.getTime() === W.getTime() ? ' ui-datepicker-today' : '')) +
                  "'" +
          ...
          Z++,
            ...
            (S +=
              ...
              (U
                ? '</div>' +
                  (B[0] > 0 && w === B[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : '')
                : '')),
            (D += S)
        }
        _ += D
  ...
  e.widget('ui.menu', {
      ...
      switch (t.keyCode) {
        ...
        default:
          ;(h = !1),
            ...
            (s =
              r && -1 !== s.index(this.active.next()) ? this.active.nextAll('.ui-menu-item') : s),
            s.length ||
              ((n = String.fromCharCode(t.keyCode)),
              (o = RegExp('^' + i(n), 'i')),
              (s = this.activeMenu.children('.ui-menu-item').filter(function () {
    ...
    _activate: function (e) {
      this.active.is('.ui-state-disabled') ||
        (this.active.children("a[aria-haspopup='true']").length ? this.expand(e) : this.select(e))
    },
    refresh: function () {
      var t,
...
;(function (e, t) {
  e.widget('ui.progressbar', {
    ...
    value: function (e) {
      return e === t
        ? this.options.value
        : ((this.options.value = this._constrainedValue(e)), this._refreshValue(), t)
    },
      ...
      return c.disabled
        ...
        : ((this.elementSize = {
          ...
          this.handles.each(function (t) {
            ...
            ;(a > i || (a === i && (t === u._lastChangedValue || u.values(t) === c.min))) &&
              ((a = i), (n = e(this)), (r = t))
          }),
          (o = this._start(t, r)),
          o === !1
    ...
    _refreshValue: function () {
      ...
      this.options.values && this.options.values.length
            ...
            ;(i = 100 * ((h.values(s) - h._valueMin()) / (h._valueMax() - h._valueMin()))),
              ...
              h.options.range === !0 &&
                ('horizontal' === h.orientation
                  ? (0 === s &&
                      h.range.stop(1, 1)[l ? 'animate' : 'css']({ left: i + '%' }, o.animate),
                    1 === s &&
                  ...
                  : (0 === s &&
                      h.range.stop(1, 1)[l ? 'animate' : 'css']({ bottom: i + '%' }, o.animate),
                    1 === s &&
                      h.range[l ? 'animate' : 'css'](
                        { height: i - t + '%' },
                        { queue: !1, duration: o.animate }
        ...
        : ((s = this.value()),
          ...
          'min' === r &&
            'horizontal' === this.orientation &&
            this.range.stop(1, 1)[l ? 'animate' : 'css']({ width: i + '%' }, o.animate),
          'max' === r &&
            'horizontal' === this.orientation &&
          ...
          'min' === r &&
            ...
            this.range.stop(1, 1)[l ? 'animate' : 'css']({ height: i + '%' }, o.animate),
          'max' === r &&
            'vertical' === this.orientation &&
            this.range[l ? 'animate' : 'css'](
              { height: 100 - i + '%' },
...
;(function (e, t) {
  ...
  function s(e) {
    return (
      e.hash.length > 1 &&
      decodeURIComponent(e.href.replace(n, '')) === decodeURIComponent(location.href.replace(n, ''))
    )
  }
        ...
        this.anchors.each(function (i, a) {
          ...
          s(a)
            ...
            : ((o = t._tabId(l)),
              (n = '#' + o),
              (r = t.element.find(n)),
              r.length || ((r = t._createPanel(o)), r.insertAfter(t.panels[i - 1] || t.tablist)),
              ...
              f(n.props, function (e, a) {
                ...
                null !== l &&
                  (null === r
                    ? (h[n] = l)
                    : (u.mod &&
                        (l - r > u.mod / 2 ? (r += u.mod) : r - l > u.mod / 2 && (r -= u.mod)),
                      (h[n] = i((l - r) * t + r, a))))
              }),
              this[a](h)
            )
          ...
          toggleClass: (function (i) {
            return function (s, a, n, r, o) {
              return 'boolean' == typeof a || a === t
                ? n
                  ? e.effects.animateClass.call(this, a ? { add: s } : { remove: s }, n, r, o)
  ...
  e.effects.effect.bounce = function (t, i) {
    ...
    for (
      ...
      (s = {}),
        ...
        (c = h ? 2 * c : c / 2)
    h && ((s = { opacity: 0 }), (s[v] = (y ? '-=' : '+=') + c), r.animate(s, m, g)),
      r.queue(function () {
  ...
  ;(e.effects.effect.puff = function (t, i) {
    ...
    (e.effects.effect.scale = function (t, i) {
      ...
      ;(a.effect = 'size'),
        ...
        (a.from =
          t.from || ('show' === n ? { height: 0, width: 0, outerHeight: 0, outerWidth: 0 } : l)),
        (a.to = {
          height: l.height * u.y,
          width: l.width * u.x,
    ...
    (e.effects.effect.size = function (t, i) {
      ...
      'show' === p && r.show(),
        ...
        'toggle' === t.mode && 'show' === p
          ...
          : ((r.from = t.from || ('show' === p ? b : s)), (r.to = t.to || ('hide' === p ? b : s))),
        (n = {
