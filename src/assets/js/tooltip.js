jQuery(document).ready(function ($) {
  ...
  $body
    .on('click', function (event) {
      ...
      if (
        (!$target.is('.js-dialogtooltip') &&
          !$target.is('.js-tooltip') &&
    ...
    .on('click', ".js-tooltip:not('.is-active')", function (event) {
      ...
      $tooltip_code =
        '<dialog id="js-tooltip" class="js-dialogtooltip ' +
        $tooltip_prefix_class +
      ...
      $tooltip_code +=
        ...
        $tooltip_prefix_class +
        'tooltip__close" data-focus-back="' +
        $tooltip_starter_id +
        '" title="' +
        $tooltip_close_title +
      ...
      if ($tooltip_title !== '') {
        $tooltip_code +=
          '<h1 id="tooltip-title" class="tooltip-title ' +
          $tooltip_prefix_class +
          'tooltip__title">' +
          $tooltip_title +
          '</h1>';
