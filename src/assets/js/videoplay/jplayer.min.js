      ...
      _init: function () {
        ...
        if (
          ...
          this.element.attr('class') ||
            this.element.attr('class', this.options.idPrefix + '_jplayer_' + this.count),
          (this.internal.self = a.extend({}, { class: this.element.attr('id'), jq: this.element })),
          ...
          (this.internal.poster = a.extend(
            {},
            { class: this.options.idPrefix + '_poster_' + this.count, jq: b }
          )),
