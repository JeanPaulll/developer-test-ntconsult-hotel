...
var myOptions = {
  ...
  styles: [
    { featureType: 'all', stylers: [{ saturation: -100 }, { gamma: 3.0 }] },
  ],
  mapTypeId: 'roadmap',
  mapTypeControl: true,
...
var map = new google.maps.Map(
  document.getElementById('travel-map-pins'),
  myOptions,
);
...
google.maps.event.addListener(infowindow, 'domready', function () {
  ...
  iwCloseBtn.css({
    opacity: '1',
    right: '50px',
    top: '36px' /*border: '7px solid #48b5e9', 'border-radius': '13px', 'box-shadow': '0 0 5px #3990B9'*/,
  });
