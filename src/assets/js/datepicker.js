  ...
  d.prototype = {
    ...
    _process_options: function (e) {
      ...
      var i = (this.o = t.extend({}, this._o)),
        a = i.language
      switch (
        (f[a] || ((a = a.split('-')[0]), f[a] || (a = u.language)), (i.language = a), i.startView)
      ) {
        case 2:
        case 'decade':
          i.startView = 2
    ...
    getClassNames: function (e) {
      var i = [],
        ...
        n = new Date()
      return (
        e.getUTCFullYear() < a || (e.getUTCFullYear() === a && e.getUTCMonth() < s)
          ? i.push('old')
          : (e.getUTCFullYear() > a || (e.getUTCFullYear() === a && e.getUTCMonth() > s)) &&
            i.push('new'),
      ...
      for (var m, y = []; p.valueOf() < D; ) {
        if (p.getUTCDay() === this.o.weekStart && (y.push('<tr>'), this.o.calendarWeeks)) {
          var w = new Date(+p + ((this.o.weekStart - p.getUTCDay() - 7) % 7) * 864e5),
            ...
            _ = new Date(
              Number((_ = i(k.getUTCFullYear(), 0, 1))) + ((11 - _.getUTCDay()) % 7) * 864e5
            ),
            C = (k - _) / 864e5 / 7 + 1
    ...
    _toggle_multidate: function (t) {
      ...
      if (
        (t ? (-1 !== e ? this.dates.remove(e) : this.dates.push(t)) : this.dates.clear(),
      ...
      parseDate: function (a, s, n) {
        ...
        if (
          ...
          for (l = 0; l < m.length; l++)
            (C = m[l]),
              C in D && !isNaN(D[C]) && ((_ = new Date(a)), y[C](_, D[C]), isNaN(_) || (a = _))
        }
        return a
      },
